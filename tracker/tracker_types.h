...
#define FDFS_DOWNLOAD_SERVER_SOURCE_FIRST    1  //the source server, 从源SERVER下载
...
typedef struct
{
    ...
    int current_write_group;  //current group index to upload file, 一个索引
